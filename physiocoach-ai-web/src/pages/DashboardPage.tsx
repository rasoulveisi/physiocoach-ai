...
export function DashboardPage() {
  ...
  return (
    <div className="flex h-full w-full overflow-hidden bg-zinc-950 text-zinc-100 selection:bg-lime-400 selection:text-zinc-950">
      <main className="flex-1 overflow-y-auto min-h-0 w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6 pb-8 select-none">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          {/* Left Column: Primary Training Schedule, Routine & Calendar (8 cols on lg) */}
        ...
        {/* Right Column: Safeguards Telemetry, AI Coach Intelligence & Posture Matrix (4 cols on lg) */}
        <div className="lg:col-span-4 space-y-6">
          {/* Dual Telemetry Split Grid */}
          <section className="grid grid-cols-2 lg:grid-cols-1 gap-3 sm:gap-4">
            {/* Clinical Safeguards */}
          ...
          <section>
            <SectionHeading title="AI Coach Intelligence" actionLabel="Assessment" to="/assessment" />
            ...
            <div className="rounded-2xl border border-zinc-800 bg-zinc-900 p-4 shadow-sm">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-1.5 text-xs leading-relaxed text-zinc-400">{coachCue}</p>
                  <Button
                    variant="outline"
                    size="sm"
                    pill={true}
                    onClick={() => navigate('/plan')}
                    className="mt-3.5 w-full text-xs font-bold border-zinc-700 hover:border-lime-400 hover:text-lime-400"
                  >
          ...
          <section>
            <SectionHeading
              title="Joint Resilience Matrix"
              actionLabel="Safeguards"
              onClick={() => navigate('/assessment')}
            />

            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-2 gap-3.5 rounded-3xl border border-zinc-800 bg-zinc-900 p-4 sm:p-5 shadow-sm">
